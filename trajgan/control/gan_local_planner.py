...
import logging
logging.basicConfig(filename='debug_local_planner.log',level=logging.DEBUG)
...
class LocalPlanner(object):
    ...
    def __init__(self, vehicle, opt_dict=None):
        ...
        logging.info('gan_local_planner initialized')
    ...
    def _init_controller(self, opt_dict):
        ...
        # default params
        self._dt = 1.0 / 20.0
        self._target_speed = 100.0  # Km/h
        self._sampling_radius = self._target_speed * 10 / 3.6  # 1 seconds horizon
    ...
    def set_global_plan(self, current_plan):
        ...
        for _ in range(self._buffer_size):
            if self._waypoints_queue:
                ...
                break
        logging.info('Waypoint queue and buffer created')
    ...
    def run_step(self, debug=True):
        ...
        """
        logging.info("In gan local planner run_step")
        ...
        if debug:
            draw_waypoints(self._vehicle.get_world(), [self.target_waypoint], self._vehicle.get_location().z + 0.5)
