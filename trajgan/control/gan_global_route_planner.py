...
import carla
from gan_local_planner import RoadOption
from agents.tools.misc import vector
import logging
logging.basicConfig(filename='global_route_planner.log',level=logging.DEBUG)
...
class GlobalRoutePlanner(object):
    ...
    def _build_graph(self):
        ...
        logging.info('global route planner: building graph')
    ...
    def trace_route(self, origin, destination):
        ...
        """
        logging.info('global route planner: tracing route')
        route_trace = []
        route = self._path_search(origin, destination)
