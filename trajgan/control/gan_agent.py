...
import logging
logging.basicConfig(filename='gan_agent.log',level=logging.DEBUG)
...
class Agent(object):
    ...
    def __init__(self, vehicle):
        ...
        logging.info('gan_agent initialized')
    ...
    def _bh_is_vehicle_hazard(self, ego_wpt, ego_loc, vehicle_list,
        ...
        for target_vehicle in vehicle_list:
            ...
            if target_wpt.road_id != ego_wpt.road_id or \
                ...
                logging.info('agent: getting next waypoint from local planner behavior')
                next_wpt = self._local_planner.get_incoming_waypoint_and_direction(steps=11)[0] #step=5
